...
$.ajax({
type: "POST",
url: access_link+"android_app/ajax_student_password_update.php?class_name="+class_name+"&class_section="+class_section+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"",
cache: false,
success: function(detail){
