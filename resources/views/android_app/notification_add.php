...
window.scrollTo(0, 0);
 ...
 <li><a href="javascript:get_content('android_app/android_app')"><i class="fa fa-dashboard"></i> Android App</a></li>
        <li><a href="javascript:get_content('android_app/notification')"><i class="fa fa-book"></i>Notification Panel</a></li>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
              ...
              <div class="box-header with-border">
              <h3 class="box-title"><b>Write Notification Here<font style="color:red"><b>*</b></font></b>
              </h3>
            ...
            <div class="box-body pad">
                    ...
                    <textarea id="" name="homework" class="form-control bordder-color" placeholder="Write Notification" rows="10" cols="80" required></textarea>
	         ...
	         <div class="col-md-4 ">	
			    ...
			    <input type="date" value="2022-12-05" name="homework_date" id="myLocalDate"  placeholder="Date"  value="" class="form-control" required>
				 </div>
