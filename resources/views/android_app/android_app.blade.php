            ...
            <a href="javascript:get_content('android_app/notification')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <a href="javascript:get_content('android_app/notification_add')" class="small-box-footer">More
            ...
            <a href="javascript:get_content('android_app/publish_marks')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#C46210;">
                        ...
                        <a href="javascript:get_content('android_app/publish_marks')" class="small-box-footer">More Info
