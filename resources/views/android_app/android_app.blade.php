    ...
    <section class="content">
	  <div class="box box-success ">
		...
		<div class="box-body">
			  ...
			  <a href="javascript:get_content('android_app/notification')">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#3B7A57;">
            <div class="inner"><br>
             ...
             <a href="javascript:get_content('android_app/notification_add')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#3498DB;">
            ...
            <a href="javascript:get_content('android_app/student_user_password_change')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#C46210;">
            <div class="inner"><br>
             ...
             <a href="javascript:get_content('android_app/publish_marks')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
