            ...
            <a href="javascript:get_content('event_management/add_house')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#FE6A0F;">
                        ...
                        <a href="javascript:get_content('event_management/add_house')" class="small-box-footer">More
            ...
            <a href="javascript:get_content('event_management/add_event')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="javascript:get_content('event_management/add_event')" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('event_management/event_result')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#5EDAF3;">
                        ...
                        <a href="javascript:get_content('event_management/event_result')" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('event_management/team_creation')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#20B5F7;">
                        ...
                        <a href="javascript:get_content('event_management/team_creation')" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
