            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <td><button type="button"  class="btn btn-danger" onclick="return valid('2');" >Restore</button></td>
	            <td><button type="button"  class="btn btn-danger" onclick="return valid1('2');" >Delete</button></td>
				 ...
				 <td><button type="button"  class="btn btn-danger" onclick="return valid('3');" >Restore</button></td>
	            <td><button type="button"  class="btn btn-danger" onclick="return valid1('3');" >Delete</button></td>
				 ...
				 <td><button type="button"  class="btn btn-danger" onclick="return valid('5');" >Restore</button></td>
	            <td><button type="button"  class="btn btn-danger" onclick="return valid1('5');" >Delete</button></td>
