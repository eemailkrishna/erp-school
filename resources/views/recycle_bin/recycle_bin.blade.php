	  ...
	  <div <div class="box box-success" >
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#E32636;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_student_admission_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#9F2B68;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_employee_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6" style="display:none" >
          <div class="small-box" style="background-color:#C46210;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_employee_salary_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6" style="display:none">
          <div class="small-box" style="background-color:#3B3B6D;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_income_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:	#FF7E00;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_expense_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6" style="display:none;">
          <div class="small-box" style="background-color:#804040;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_bus_staff_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6" style="display:none;">
          <div class="small-box" style="background-color:#34B334;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_bus_student_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6" style="display:none;">
          <div class="small-box" style="background-color:#551B8C;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_library_book_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#915C83;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_hostel_student_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#4B5320;">
            ...
            <a href="javascript:get_content('recycle_bin/recycle_hostel_account_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#b55e35;">
            ...
            <a href="javascript:get_content('recycle_bin/student_registration_list')" class="small-box-footer">More Info<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
