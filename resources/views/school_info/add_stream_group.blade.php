...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<form role="form"  method="post" enctype="multipart/form-data" id="my_form">
                ...
                <table id="table-data" class="table table-bordered table-striped">
					...
					<td>
					<input type="button"  onclick="form_submit();" value="Add Group" class="btn btn-success" />
					</td>
...
<tbody>
	...
	<th><button type="button" class="btn btn-success"  onclick="group_delete('id=1&stream_group=7&stream_code=stream1')">Delete</th>
	            </tr>
								</tbody>
