	  ...
	  <div <div class="box box-success" >
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#E32636;">
            ...
            <a href="{{url('/school-school_general_info')}}" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#FBAA00;">
            ...
            <a href="javascript:get_content('school_info/exam_type_add_monthly')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-md-3 col-md-6" style="display:none">
          <div class="small-box" style="background-color:#4B5320;">
            ...
            <a href="javascript:get_content('school_info/rfid_card_add')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#716B70;">
            ...
            <a href="{{url('/school-info_addfeecategory')}}" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#1D8A73;">
            ...
            <a href="{{url('/schoolInfo-AddBusFeeCategory-MonthlyInstallmentwise')}}" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#3B3B6D;">
            ...
            <a href="{{url('schoolInfo-addstudentidentitycategory')}}" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#333432;">
            ...
            <a href="{{url('/school-info_syllabusDetails')}}" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
	  ...
	  <div <div class="box box-success" >
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#171F63;">
            ...
            <a href="{{url('/school-info_academic-calender')}}" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
