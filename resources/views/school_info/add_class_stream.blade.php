...
<tbody>
	...
	<th  >LLB</th>
	<th  ></th>
	<th  ><button type="button" id="stream1" name="LLB-" class="btn btn-success" onclick="add_edit(this.id,this.name)" data-toggle="modal" data-target="#myModal" >Edit</th>

	            </tr>
																<tr  align='center' >
	<th colspan="4" ><button type="button" id="stream2" name="-" class="btn btn-success" onclick="add_edit(this.id,this.name)" data-toggle="modal" data-target="#myModal" >Add More</th>
						</tbody>
...
<div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<input type="hidden" name="stream_code_hidden" id="stream_code_hidden" class="form-control">
	  </div>
	         <div class="form-group">
		<label>Class Hindi Add/Edit</label>
		<input type="text" name="stream_name_hindi" id="stream_name_hindi" class="form-control">
		
	  </div>
        </div>
        <div class="modal-footer">
		<input type="submit"   value="Add" class="btn btn-success" />
          <button type="button" id="myModal_close" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
      </div>
