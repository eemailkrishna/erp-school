...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('homework/homework')"><i class="fa fa-book"></i> Classwork</a></li>
 ...
 <div class="col-md-12">
		...
		<div class="col-md-3" id="student_class_group_div" style="display:none;">				
				...
				<div class="form-group" >
				<label>Date</label>
			    <input type="date" value="2022-12-05" name="classwork_date" id="myLocalDate"  placeholder="Date"  value="" class="form-control">
				 </div>
			  </div>
