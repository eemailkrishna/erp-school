 ...
 $('#student_class_group').html("<option value='' >Loading....</option>");
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('homework/classwork_list')"><i class="fa fa-list"></i>  classwork List</a></li>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
            ...
            <div class="box-body "  >
			  ...
			  <div class="form-group" >
				 <label >Class</label>
				 <select class="form-control" onchange="for_section(this.value);for_subject();for_stream(this.value)" id="classwork_class" name="classwork_class" value="">
		...
		<div class="col-md-3" id="student_class_group_div" style="display:none;"  >				
			  ...
			  <div class="col-md-3 ">	
				<div class="form-group" >
				<label>Date</label>
			    <input type="date" value="03-12-2022" name="classwork_date" id="myLocalDate" class="form-control">
				 </div>
			  </div>
			  			  <div class="col-md-3 ">		
				<div class="form-group">
				<label>Remark</label>
				<input type="text" name="classwork_remark" placeholder="Write Remark"  value="" class="form-control">
				</div>
			  </div>
			  </div>
            ...
            <div class="box-body pad">
			 ...
			 <input type="hidden" id="count_value" value="1" ></input> <input type="hidden" name="edit_id" value="209" ></input>
             <input type="text" id="question_box" rows="2" onKeyUp="get_text_question()" name="content" class="form-control" style="display:none">
			 
                    <textarea id="editor1" name="classwork" class="form-control bordder-color" placeholder="write homework" rows="10" cols="80" >   
