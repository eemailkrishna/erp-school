             ...
             <a href="javascript:get_content('library/library_add_book')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#E32636;">
                         ...
                         <a href="javascript:get_content('library/library_add_book')" class="small-box-footer">More Info
             ...
             <a href="javascript:get_content('library/view_book_library')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#3B7A57;">
                         ...
                         <a href="javascript:get_content('library/view_book_library')" class="small-box-footer">More
             ...
             <a href="javascript:get_content('library/view_issued_book_list')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#9F2B68;">
                         ...
                         <a href="javascript:get_content('library/view_issued_book_list')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             <a href="javascript:get_content('library/view_return_book_list')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#C46210;">
                         ...
                         <a href="javascript:get_content('library/view_return_book_list')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             <a href="javascript:get_content('library/e_library')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#3B3B6D;">
                         ...
                         <a href="javascript:get_content('library/e_library')" class="small-box-footer">More Info <i
             ...
             <a href="javascript:get_content('library/exam_stuff_add')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#D68910;">
                         ...
                         <a href="javascript:get_content('library/exam_stuff_add')" class="small-box-footer">More Info
                             <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
