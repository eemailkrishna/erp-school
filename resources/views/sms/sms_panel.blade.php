               ...
               <a href="javascript:get_content('sms/holiday_sms')">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:#800080;">
                           ...
                           <a href="javascript:get_content('sms/holiday_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/birthday_sms')">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#008080;">
                           ...
                           <a href="javascript:get_content('sms/birthday_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="javascript:get_content('sms/student_notification')">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#008000;">
                           ...
                           <a href="javascript:get_content('sms/student_notification')" class="small-box-footer">More
               ...
               <a href="javascript:get_content('sms/message_list')">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#800000;">
                           ...
                           <a href="javascript:get_content('sms/message_list')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="javascript:get_content('sms/sms_from_mobile')">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#000080;">
                           ...
                           <a href="javascript:get_content('sms/sms_from_mobile')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="javascript:get_content('sms/delivery_report')">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#C46210;">
                           ...
                           <a href="javascript:get_content('sms/delivery_report')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="javascript:get_content('sms/delivery_print_report')">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#C46210;">
                           ...
                           <a href="javascript:get_content('sms/delivery_print_report')" class="small-box-footer">More
                               Info <i class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
