              ...
              <a href="javascript:get_content('live_bus/bus_password_change')">
                  <div class="col-lg-3 col-xs-6">
                      <div class="small-box" style="background-color:#E32636;">
                          ...
                          <a href="javascript:get_content('live_bus/bus_password_change')" class="small-box-footer">More
              ...
              <a href="javascript:get_content('live_bus/bus_location_live')">
                  <div class="col-lg-3 col-xs-6">
                      <div class="small-box" style="background-color:	#808000;">
                          ...
                          <a href="javascript:get_content('live_bus/bus_location_live')" class="small-box-footer">More
                              info <i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                  </div>
              </a>
              <a href="javascript:get_content('live_bus/bus_location_route')">
                  <div class="col-lg-3 col-xs-6">
                      <div class="small-box" style="background-color:	#808080;">
                          ...
                          <a href="javascript:get_content('live_bus/bus_location_route')" class="small-box-footer">More
                              info <i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                  </div>
              </a>
