			   ...
			   <div class="col-md-12">
			      ...
			      <div class="col-md-6">
						  ...
						  <label>Add Session<font style="color:red"><b>*</b></font></label>
						   <center><input type="text"  name="add_session" placeholder="Add session"  value="2025_26" class="form-control" readonly ></center>
						</div>
				    ...
				    <div class="col-md-6 ">
						<div class="form-group">
						   ...
						   <center><input type="date"  name="creation_date" placeholder=""  value="2022-12-05" class="form-control" readonly></center>
						</div>
				   </div>
				...
				<tbody>
					<tr>
					   ...
					   <td>2022-01-18</td>
					   <td>2022</td>
				       <th><button type="button"  class="btn btn-danger" onclick="return valid('6');" >Delete</button></th>
                   </tr>
				...
				<tbody>
					<tr>
					   ...
					   <td>2022-11-22</td>
					   <td>2023</td>
				       <th><button type="button"  class="btn btn-danger" onclick="return valid('22');" >Delete</button></th>
                   </tr>
				...
				<tbody>
					<tr>
					   ...
					   <td>2022-12-01</td>
					   <td>2024</td>
				       <th><button type="button"  class="btn btn-danger" onclick="return valid('25');" >Delete</button></th>
                   </tr>
									</tbody>
