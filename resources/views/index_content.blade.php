            ...
            <a href="{{url('smartclass')}}">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#884EA0;">
                        ...
                        <a href="javascript:get_content('smartclass/smartclass')" class="small-box-footer">More Info <i
            ...
            <a href="javascript:get_content('attendance/attendance')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="javascript:get_content('attendance/attendance')" class="small-box-footer">More Info
            ...
            <a href="javascript:get_content('enquiry/enquiry')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <a href="javascript:get_content('enquiry/enquiry')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('staff/staff')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        ...
                        <a href="javascript:get_content('staff/staff')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('student/students')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#C46210;">
                        ...
                        <a href="javascript:get_content('student/students')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title" style="color:teal;"><i
                            class="fa fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;<b>New Panels</b></h3>
                </div>
                <div class="box-body">
                    <a href="{{url('smartclass')}}">
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box" style="background-color:#884EA0;">
                                <div class="inner"><br>
                                    <h3 style="font-size:20px;margin-left:10px;color:#fff;">Smart Class School Panel
                                    </h3>
                                    <p style="margin-left:10px;color:#fff;">Enter</p>
                                </div>
                                <a href="javascript:get_content('smartclass/smartclass')" class="small-box-footer">More
                    ...
                    <a href="https://simptionsmartclass.com/demo.php" target="_blank">
                        <div style="display:none" class="col-lg-3 col-xs-6">
                            <div class="small-box" style="background-color:#D35400;">
                                <div class="inner"><br>
                                    <h3 style="font-size:20px;margin-left:10px;color:#fff;">Smart Class Student
                                        Panel<img src="http://uppsc.up.nic.in/images/new_2.gif" alt="" border="0"></h3>
                                    <i class="ion"><img src="../../school_software_v1_old/images/paid-min.png"
                                            style="width:70px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "
                                            title="School Management System" class="image1"></i>
                                </div>
                                <a href="https://simptionsmartclass.com" target="_blank" class="small-box-footer">More
                                    Info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="javascript:get_content('attendance/attendance')">
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box" style="background-color:#E32636;">
                                ...
                                <a href="javascript:get_content('attendance/attendance')" class="small-box-footer">More
                                    Info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </a>
                    <a href="javascript:get_content('enquiry/enquiry')">
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box" style="background-color:#3B7A57;">
                                ...
                                <a href="javascript:get_content('enquiry/enquiry')" class="small-box-footer">More Info
                                    <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="javascript:get_content('student/students')">
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box" style="background-color:#C46210;">
                                ...
                                <a href="javascript:get_content('student/students')" class="small-box-footer">More Info
                                    <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </a>
            ...
            <a href="javascript:get_content('account/account')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B3B6D;">
                        ...
                        <a href="javascript:get_content('account/account')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('dues/dues')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#FF7E00;">
                        ...
                        <a href="javascript:get_content('dues/dues')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('fees_monthly/fees')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#804040;">
                        ...
                        <a href="javascript:get_content('fees_monthly/fees')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('penalty/penalty')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:	#34B334;">
                        ...
                        <a href="javascript:get_content('penalty/penalty')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('certificate/certificate')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#551B8C;">
                        ...
                        <a href="javascript:get_content('certificate/certificate')" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('examination/examination')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#915C83;">
                        ...
                        <a href="javascript:get_content('examination/examination')" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('homework/homework')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#4B5320;">
                        ...
                        <a href="javascript:get_content('homework/homework')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('exam_paper_setter/exam_paper_setter')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B444B;">
                        ...
                        <a href="javascript:get_content('adminexam_paper_setter/exam_paper_setter')"
                            class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('complaint/complaint')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#A2006D;">
                        ...
                        <a href="javascript:get_content('complaint/complaint')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('gallery/gallery')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#007FFF;">
                        ...
                        <a href="javascript:get_content('gallery/gallery')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('sms/sms_panel')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#FF1493;">
                        ...
                        <a href="javascript:get_content('sms/sms')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('time_table/time_table')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#21ABCD;">
                        ...
                        <a href="javascript:get_content('time_table/time_table')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('holiday/holiday')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#7C0A02;">
                        ...
                        <a href="javascript:get_content('holiday/holiday')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('leave/leave')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#E48400;">
                        ...
                        <a href="javascript:get_content('leave/leave')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('sports/sports')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#CC6666;">
                        ...
                        <a href="javascript:get_content('sports/sports')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('important/important')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#0088DC;">
                        ...
                        <a href="javascript:get_content('important/important')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('downloads/downloads')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#CC0000;">
                        ...
                        <a href="javascript:get_content('downloads/downloads')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('recycle_bin/recycle_bin')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#006A4E;">
                        ...
                        <a href="javascript:get_content('recycle_bin/recycle_bin')" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('session/session')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#8A2BE2;">
                        ...
                        <a href="javascript:get_content('session/session')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('reminder/reminder')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#993300;">
                        ...
                        <a href="javascript:get_content('reminder/reminder')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('school_info/school_info')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#800020;">
                        ...
                        <a href="javascript:get_content('school_info/school_info')" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('utility/login_details')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#24A0ED;">
                        ...
                        <a href="javascript:get_content('utility/login_details')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('bus/bus')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#ED872D;">
                        ...
                        <a href="javascript:get_content('bus/bus')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('hostel/hostel')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#9955BB;">
                        ...
                        <a href="javascript:get_content('hostel/hostel')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('library/library')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#00CC99;">
                        ...
                        <a href="javascript:get_content('library/library')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('stock/stock')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3C1421;">
                        ...
                        <a href="javascript:get_content('stock/stock')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('live_bus/bus_tracking')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#551B8C;">
                        ...
                        <a href="javascript:get_content('live_bus/bus_tracking')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('android_app/android_app')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#915C83;">
                        ...
                        <a href="javascript:get_content('android_app/android_app')" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('user_right/user_right')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#0088DC;">
                        ...
                        <a href="javascript:get_content('user_right/user_right')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('gate_pass/gate_pass')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#5F5CdD;">
                        ...
                        <a href="javascript:get_content('gate_pass/gate_pass')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('pdf_format/pdf_format')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#EF5C5D;">
                        ...
                        <a href="javascript:get_content('pdf_format/pdf_format')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('pdf_format/youtube_videos')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#5FEC5D;">
                        ...
                        <a href="javascript:get_content('pdf_format/youtube_videos')" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
