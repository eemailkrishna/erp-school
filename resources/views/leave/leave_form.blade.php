			 ...
			 <div class="col-md-6 ">				
					<div class="form-group" >
					  ...
					  <option value="">Select student</option>
					        							<option value="2000161">Tanu yadav[2000161]-[2ND-A]-[Gopal yadav-9826300978]</option>
														<option value="2000268">Aaysha Bano[2000268]-[2ND-B]-[Shahbudeen kathat-9001807360]</option>
														<option value="2000271">sourabh[2000271]-[2ND-B]-[gaurav-123456789]</option>
														<option value="2000286">SHAILESH SHARMA[2000286]-[2ND-B]-[HARI SHANKER SHARMA-9917473809]</option>
														...
														<option value="2200995">Gudiya kumari[2200995]-[LKG-A]-[Banti sharma-8809612215]</option>
														<option value="2200996">Aditya kumar[2200996]-[NURSERY-A]-[Naresh sharma-9955384775]</option>
														<option value="2200997">Anshu kumar[2200997]-[NURSERY-A]-[Lavkush kumar-8377912973]</option>
														<option value="2200998">Naina khatun[2200998]-[NURSERY-A]-[Samsher aalam-8793140571]</option>
														<option value="2200999">Subham kumar[2200999]-[LKG-A]-[Dhaneshwar singh-6207819941]</option>
														<option value="2201001">Rahul Kumar [2201001]-[1ST-A]-[Ajay singh-7764952499]</option>
														<option value="2201002">Varsha kumari[2201002]-[NURSERY-A]-[Ajay ram-7909043168]</option>
														<option value="2201003">Simran kumari[2201003]-[LKG-A]-[Sushil kumar gupta-63678555352]</option>
														...
														<option value="2201088">NIDHI SINGH [2201088]-[7TH-A]-[SAMSHER SINGH -7554154464]</option>
														<option value="2201089">rakesh tailor[2201089]-[1ST-A]-[ganpat lal-9413137558]</option>
				...
				<div class="col-md-4 ">	
					<div class="form-group" >
					  ...
					  <input type="date"  id="leave_from_date" name="leave_from_date" placeholder="Leave From " onchange="check_date();" value="" class="form-control">
					</div>
				  </div>
				<div class="col-md-4 ">	
					<div class="form-group" >
					  <label>Leave To</label>
					  <input type="date"  onchange="check_date();" id="leave_to_date" name="leave_to_date" placeholder="Leave To"  value="" class="form-control">
					</div>
				  </div>
				  <div class="col-md-4 ">	
					<div class="form-group" >
					  <label>Approved By</label>
					  <input type="text"  name="approved_by" placeholder="Approved By"  value="" class="form-control">
					</div>
				  </div>
				  <div class="col-md-3 ">	
					<div class="form-group" >
				     ...
				     <div class="col-md-1">	
					<div class="form-group" >
					  <img src="../school_software_v1_old/images/student_blank.png" id="show_application" height="50" width="50" >
					</div>
				</div>
				  <div class="col-md-2 ">	
					<div class="form-group" >
					  <label>Total leave days</label>
					  <input type="text"  name="total_leave_days" id="total_leave_days" placeholder="Total leave days"  value="" class="form-control">
					</div>
				  </div>
				  <div class="col-md-1 ">	
					<div class="form-group" >
