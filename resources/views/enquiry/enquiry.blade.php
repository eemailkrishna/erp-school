                ...
                <a href="javascript:get_content('enquiry/add_enquiry');">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#E32636;">
                            ...
                            <a href="javascript:get_content('enquiry/add_enquiry');" class="small-box-footer">More Info
                ...
                <a href="javascript:get_content('enquiry/enquiry_list')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#3B7A57;">
                            ...
                            <a href="javascript:get_content('enquiry/enquiry_list')" class="small-box-footer">More Info
                                <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </a>
                ...
                <a href="javascript:get_content('enquiry/enquiry_sms_list')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#8F736D;">
                            ...
                            <a href="javascript:get_content('enquiry/enquiry_sms_list')" class="small-box-footer">More
                ...
                <a href="javascript:get_content('enquiry/call_student_list')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#808000;">
                            ...
                            <a href="javascript:get_content('enquiry/call_student_list')" class="small-box-footer">More
                                Info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </a>
