            ...
            <a href="javascript:get_content('hostel/hostel_list')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="javascript:get_content('hostel/hostel_list')" class="small-box-footer">More Info <i
            ...
            <a href="javascript:get_content('hostel/room_list')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <a href="javascript:get_content('hostel/room_list')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('hostel/hostel_seat_avail')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        ...
                        <a href="javascript:get_content('hostel/hostel_seat_avail')" class="small-box-footer">More Info
            ...
            <a href="javascript:get_content('hostel/staff')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#FF7E00;">
                        ...
                        <a href="javascript:get_content('hostel/staff')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('hostel/hostel_student_list')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#C46210;">
                        ...
                        <a href="javascript:get_content('hostel/hostel_student_list')" class="small-box-footer">More
            ...
            <a href="javascript:get_content('hostel/hostel_mess')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B3B6D;">
                        ...
                        <a href="javascript:get_content('hostel/hostel_mess')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('hostel/leave_student')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#804040;">
                        ...
                        <a href="javascript:get_content('hostel/leave_student')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('hostel/hostel_account')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#551B8C;">
                        ...
                        <a href="javascript:get_content('hostel/hostel_account')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
