		...
		<div class="box-body">
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#E32636;">
							...
							<a href="javascript:get_content('downloads/select_student')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#E32636;">
							...
							<a href="javascript:get_content('downloads/select_student_groupwise')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#417df4;">
							...
							<a href="javascript:get_content('downloads/employee_download')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#e541f4;">
							...
							<a href="javascript:get_content('downloads/employee_salary')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#e20425;">
							...
							<a href="javascript:get_content('downloads/enquiry_download_info')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#f22804;">
							...
							<a href="javascript:get_content('downloads/student_fees_download_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#034cf1;">
							...
							<a href="javascript:get_content('downloads/account_expense_info')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#75a4ef;">
							...
							<a href="javascript:get_content('downloads/account_info_download')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#206b6f;">
							...
							<a href="javascript:get_content('downloads/Attendance_download_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-md-3 col-md-6">
						<div class="small-box" style="background-color:#F56F9A;">
							...
							<a href="javascript:get_content('downloads/userid_password')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
            ...
            <div class="col-md-3 col-md-6">
                <div class="small-box" style="background-color:#f73573;">
                    ...
                    <a href="javascript:get_content('downloads/student_tc')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </a>
		</div>
