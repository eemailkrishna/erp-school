             ...
             <a href="javascript:get_content('downloads/select_student')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#E32636;">
                         ...
                         <a href="javascript:get_content('downloads/select_student')" class="small-box-footer">More Info
             ...
             <a href="javascript:get_content('downloads/employee_download')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#417df4;">
                         ...
                         <a href="javascript:get_content('downloads/employee_download')" class="small-box-footer">More
             ...
             <a href="javascript:get_content('downloads/employee_salary')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#e541f4;">
                         ...
                         <a href="javascript:get_content('downloads/employee_salary')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             ...
             <a href="javascript:get_content('downloads/userid_password')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#F56F9A;">
                         ...
                         <a href="javascript:get_content('downloads/userid_password')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             <a href="javascript:get_content('downloads/student_tc')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#f73573;">
                         ...
                         <a href="javascript:get_content('downloads/student_tc')" class="small-box-footer">More Info <i
