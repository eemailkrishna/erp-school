...
<!------------------------------------------------Start Registration form--------------------------------------------------->
            ...
            <div class="col-md-12">
            <span style="float:right;"><input type="checkbox" value="" id="cls" onclick="for_check(this.id);" checked><th><b style="color:red;">Check All Class/Unchecked All</b></th></span>
            </div>
			
            <div class="col-md-12">
            <th><b style="font-size:15px">Student Class : </b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="NURSERY" class="cls" checked /> NURSERY&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="LKG" class="cls" checked /> LKG&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="UKG" class="cls" checked /> UKG&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="1ST" class="cls" checked /> 1ST&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="2ND" class="cls" checked /> 2ND&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="3RD" class="cls" checked /> 3RD&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="4TH" class="cls" checked /> 4TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="5TH" class="cls" checked /> 5TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="6TH" class="cls" checked /> 6TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="7TH" class="cls" checked /> 7TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="8TH" class="cls" checked /> 8TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="9TH" class="cls" checked /> 9TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="10TH" class="cls" checked /> 10TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="11TH" class="cls" checked /> 11TH&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="12TH" class="cls" checked /> 12TH&nbsp;&nbsp;</b></th>
                        </div>
            
            <div class="col-md-12">
            <th><b style="font-size:15px">Student Stream : </b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="student_class_stream[]" id="" value="SCIENCE" class="stream" /> SCIENCE&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="student_class_stream[]" id="" value="ARTS" class="stream" /> ARTS&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="student_class_stream[]" id="" value="Commerce " class="stream" /> Commerce &nbsp;&nbsp;</b></th>
                        </div>
            
            <div class="col-md-12">
            <th><b style="font-size:15px">Student Group : </b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="student_class_group[]" id="" value="Group-A" class="group" /> Group-A&nbsp;&nbsp;</b></th>
                        <th><b style="font-size:15px"><input type="checkbox" name="student_class_group[]" id="" value="Group-B" class="group" /> Group-B&nbsp;&nbsp;</b></th>
                        </div>
            
            <div class="col-md-12">
            <span style="float:right;"><input type="checkbox" value="" id="sec" onclick="for_check(this.id);" checked><th><b style="color:red;">Check All Section/Unchecked All</b></th></span>
            </div>
            
            <div class="col-md-12">
            <th><b style="font-size:15px">Student Section : </b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="A" class="sec" checked /> A&nbsp;&nbsp;</b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="B" class="sec" checked /> B&nbsp;&nbsp;</b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="C" class="sec" checked /> C&nbsp;&nbsp;</b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="D" class="sec" checked /> D&nbsp;&nbsp;</b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="E" class="sec" checked /> E&nbsp;&nbsp;</b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="F" class="sec" checked /> F&nbsp;&nbsp;</b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="G" class="sec" checked /> G&nbsp;&nbsp;</b></th>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_section[]" id="" value="H" class="sec" checked /> H&nbsp;&nbsp;</b></th>
            </div>
				     ...
				     <select class="form-control select2" name="student_adress" id="student_adress" style="width:100%">
					           <option  value="All">All</option>
						       								<option value=""></option>
																...
																<option value="112-B Kachiyana, CSJM University Kanpur">112-B Kachiyana, CSJM University Kanpur</option>
																...
																<option value="314 Balajipuram, Makdikheda, Kanpur Nagar">314 Balajipuram, Makdikheda, Kanpur Nagar</option>
																<option value="4/130,PERIYAKADU, NAVALUR POST, ATTUR TALUK">4/130,PERIYAKADU, NAVALUR POST, ATTUR TALUK</option>
																...
																<option value="975 naw bhar colony station bhopal ">975 naw bhar colony station bhopal </option>
																<option value="Acb">Acb</option>
																<option value="agra">agra</option>
																<option value="Alert place colony hathras road tedi bagiya agra-6">Alert place colony hathras road tedi bagiya agra-6</option>
																<option value="Anand Nagar">Anand Nagar</option>
																<option value="Anand nagar Bhopal, Madhya Pradesh ">Anand nagar Bhopal, Madhya Pradesh </option>
																<option value="Araria ">Araria </option>
																<option value="ashok nagar ">ashok nagar </option>
																<option value="ashoka garden ">ashoka garden </option>
																<option value="At.Post.Khapar Tel. Akkalkuwa Dist. Nandurbar ">At.Post.Khapar Tel. Akkalkuwa Dist. Nandurbar </option>
																<option value="At.Post.Khapar Tel.Akkalkuwa Dist.Nandurbar 425419">At.Post.Khapar Tel.Akkalkuwa Dist.Nandurbar 425419</option>
																...
																<option value="BEHIND OF police STATION HASTINAPUR BAMOREKALAN">BEHIND OF police STATION HASTINAPUR BAMOREKALAN</option>
																<option value="Belwa Sammay Road Colonelganj Dist. Gonda">Belwa Sammay Road Colonelganj Dist. Gonda</option>
																<option value="bhopal">bhopal</option>
																<option value="bhuna">bhuna</option>
																<option value="BIRSINGHPUR">BIRSINGHPUR</option>
																<option value="bodla">bodla</option>
																<option value="C-4, SECOND FLOOR, PRABHAT SQUARE BHOPAL">C-4, SECOND FLOOR, PRABHAT SQUARE BHOPAL</option>
																<option value="C/O CENTRAL PUBLIC SCHOOL, NEAR VIRENDRA VATIKA JAIL ROAD, BHIND">C/O CENTRAL PUBLIC SCHOOL, NEAR VIRENDRA VATIKA JAIL ROAD, BHIND</option>
																...
																<option value="Ek dalia birampur, Lalgola, West Bengal ">Ek dalia birampur, Lalgola, West Bengal </option>
																<option value="G">G</option>
																<option value="G 1 T230">G 1 T230</option>
																<option value="GARHPURA">GARHPURA</option>
																<option value="GAT NO. 887-890; Flat no. A-205, mainland valencia, kesnand,  taluka- haveli, district-pune">GAT NO. 887-890; Flat no. A-205, mainland valencia, kesnand,  taluka- haveli, district-pune</option>
																...
																<option value="Jagdev Nagar,PO. Anaith, Gali No 7">Jagdev Nagar,PO. Anaith, Gali No 7</option>
																...
																<option value="Krishna Kutumb, Rama Dental College Lakhanpur, Kanpur Nagar">Krishna Kutumb, Rama Dental College Lakhanpur, Kanpur Nagar</option>
																...
																<option value="Nagla ramkishun post Bihar dist Farrukhabad up">Nagla ramkishun post Bihar dist Farrukhabad up</option>
																<option value="Naya Bazar pachna road lakhisarai">Naya Bazar pachna road lakhisarai</option>
																<option value="NEAR BUS-STAND">NEAR BUS-STAND</option>
																<option value="Near Khadi Asharam Durga Nagar Dibiyapur ">Near Khadi Asharam Durga Nagar Dibiyapur </option>
																...
																<option value="Oil Seedsfarm, Kalyanpur, Kanpur Nagar">Oil Seedsfarm, Kalyanpur, Kanpur Nagar</option>
																...
																<option value="Plot no 45 prabhat  resisency  meghpar  kumbaradi  anjar kutch">Plot no 45 prabhat  resisency  meghpar  kumbaradi  anjar kutch</option>
																<option value="Police line byron bazar raipur">Police line byron bazar raipur</option>
																<option value="ptu">ptu</option>
																<option value="puspa nagar railway station bhopal ">puspa nagar railway station bhopal </option>
																<option value="rbl">rbl</option>
																<option value="Revelganj">Revelganj</option>
																<option value="Rom">Rom</option>
																<option value="Rom italy">Rom italy</option>
																<option value="S/634 ">S/634 </option>
																<option value="S/O SHYAM SUNDER SHARMA 111 HATHI, DARWAZA GOVERDHAN BRAHMNAN MATHURA">S/O SHYAM SUNDER SHARMA 111 HATHI, DARWAZA GOVERDHAN BRAHMNAN MATHURA</option>
																...
																<option value="VILL- PAKHANPUR, POST- AHIRAULA, DISTT- AZAMGARH">VILL- PAKHANPUR, POST- AHIRAULA, DISTT- AZAMGARH</option>
																<option value="Vill-Champa">Vill-Champa</option>
																<option value="Vill-Khanamukh, P.O- Nonkey Patgaon, Dist-sonitpur(Assam)Pin-784101">Vill-Khanamukh, P.O- Nonkey Patgaon, Dist-sonitpur(Assam)Pin-784101</option>
																<option value="Vill-Post Harrajpura, Masuda,Ajmer(Raj)">Vill-Post Harrajpura, Masuda,Ajmer(Raj)</option>
																<option value="Vill. & P. O. Bazarghat, P.S. - Ratabari, District- Karimganj, State - Assam, Pin-788733">Vill. & P. O. Bazarghat, P.S. - Ratabari, District- Karimganj, State - Assam, Pin-788733</option>
																<option value="VILL. KUMBRA">VILL. KUMBRA</option>
																<option value="VILLAGE BARTAL,NAWABGANJ,FARRUKHABAD">VILLAGE BARTAL,NAWABGANJ,FARRUKHABAD</option>
																<option value="VILLAGE OF ITAURA ">VILLAGE OF ITAURA </option>
																<option value="Village-Kanvi PO-Pilkhuwa District-Hapur">Village-Kanvi PO-Pilkhuwa District-Hapur</option>
																<option value="WARD NO 12">WARD NO 12</option>
																<option value="ward no 6">ward no 6</option>
																<option value="WARD NO. 8, DHARAMRAYCHAK, PURANI BAZAR, LAKHISARAI">WARD NO. 8, DHARAMRAYCHAK, PURANI BAZAR, LAKHISARAI</option>
				     ...
				     <select class="form-control" name="student_block" id="student_block" style="width:100%">
					           <option  value="All">All</option>
						       								<option value=""></option>
																...
																<option value="bhopal">bhopal</option>
																<option value="bhopal main railway station bhopal ">bhopal main railway station bhopal </option>
