	  ...
	  <a href="{{ url('fee-structure') }}">
        ...
        <div class="col-lg-3 col-xs-6" style="display:none;">
          <div class="small-box" style="background-color:#3B7A57;">
            ...
            <div class="icon">
              <i class="ion"><img src="{{url('images/discount_structure.png')}}" style="width:80px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "  title="School Management System" class="image1"></i>
            </div>
	  ...
	  <div class="box">
		...
		<a href="userhelp/Fee Panel.pdf" target="_blank">
					<div class="col-lg-3 col-xs-6">
						...
						<div class="icon">
							<i class="ion"><img src="{{url('images/userhelp.png')}}" style="width:80px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "  title="School Management System" class="image1"></i>
						</div>
