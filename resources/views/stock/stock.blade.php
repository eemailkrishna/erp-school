                ...
                <a href="javascript:get_content('stock/category_add')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#87A518;">
                            ...
                            <a href="javascript:get_content('stock/category_add')" class="small-box-footer">More Info <i
                ...
                <a href="javascript:get_content('stock/category_list')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#053332;">
                            ...
                            <a href="javascript:get_content('stock/category_list')" class="small-box-footer">More Info
                ...
                <a href="javascript:get_content('stock/add_item')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#E32636;">
                            ...
                            <a href="javascript:get_content('stock/add_item')" class="small-box-footer">More Info <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </a>
                <a href="javascript:get_content('stock/item_list')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#42EA21;">
                            ...
                            <a href="javascript:get_content('stock/item_list')" class="small-box-footer">More Info <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </a>
                ...
                <a href="javascript:get_content('stock/purchase_list')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#3B7A57;">
                            ...
                            <a href="javascript:get_content('stock/purchase_list')" class="small-box-footer">More Info
                                <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </a>
                ...
                <a href="javascript:get_content('stock/sale_list')">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box" style="background-color:#C46210;">
                            ...
                            <a href="javascript:get_content('stock/sale_list')" class="small-box-footer">More Info <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </a>
