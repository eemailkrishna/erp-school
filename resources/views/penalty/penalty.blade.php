             ...
             <a href="javascript:get_content('penalty/penalty_form')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#E32636;">
                         ...
                         <a href="javascript:get_content('penalty/penalty_form')" class="small-box-footer">More Info <i
             ...
             <a href="javascript:get_content('penalty/penalty_list')">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#3B7A57;">
                         ...
                         <a href="javascript:get_content('penalty/penalty_list')" class="small-box-footer">More Info <i
                                 class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
