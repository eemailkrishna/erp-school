            ...
            <a href="javascript:get_content('time_table/add_class_period')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#33E6E6;">
                        ...
                        <a href="javascript:get_content('time_table/add_class_period')" class="small-box-footer">More
            ...
            <a href="javascript:get_content('time_table/time_table_generate')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="javascript:get_content('time_table/time_table_generate')" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('time_table/time_table_list')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        ...
                        <a href="javascript:get_content('time_table/time_table_list')" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('time_table/teacher_assign')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#3B6AA7;">
                        ...
                        <a href="javascript:get_content('time_table/teacher_assign')" class="small-box-footer">More Info
            ...
            <a href="javascript:get_content('time_table/time_table_sheet')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#808000;">
                        ...
                        <a href="javascript:get_content('time_table/time_table_sheet')" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
