		   ...
		   <div class="box-body">
			...
			<div class="col-md-12">
				...
				<div class="col-md-5">
					 <div class="form-group" >
					    <label>Old / New</label>
						<input type="text" name='paper_type' id="paper_type" value="old" class='form-control' readonly />
					</div>
				</div>
				 ...
				 <div class="col-md-5">
					<div class="form-group" id="text_select" >
						...
						<input type="text" name='paper_unique_id' id="paper_unique_id" value="1ST_computer_objective_25_08_2021_English" class='form-control' readonly />
					</div>
				 </div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-5">
					 <div class="form-group" >
					    <label>Class</label>
						<input type="text" name='question_class' id="question_class" value="1ST" class='form-control' readonly />
					</div>
				</div>
				 ...
				 <div class="col-md-5">
					 <div class="form-group" >
					  <label>Subject</label>
					  <input type="text" name='question_subject' id="question_subject" value="computer" class='form-control' readonly />
					</div>
				 </div>
			 ...
			 <div class="col-md-12 ">
				...
				<div class="col-md-5">
					 <div class="form-group" >
					  ...
					  <input type="text" name='question_exam_type' id="question_exam_type" value="objective" class='form-control' readonly />
					</div>
				</div>
