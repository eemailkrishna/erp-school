             ...
             <a href="javascript:get_content('examination/admit_card')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#E32636;">
                         ...
                         <a href="javascript:get_content('examination/admit_card')" class="small-box-footer">More Info
             ...
             <a href="javascript:get_content('examination/admit_card_print')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#3B7A57;">
                         ...
                         <a href="javascript:get_content('examination/admit_card_print')" class="small-box-footer">More
             ...
             <a href="javascript:get_content('examination/marksheet_fill')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#9F2B68;">
                         ...
                         <a href="javascript:get_content('examination/marksheet_fill')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             ...
             <a href="javascript:get_content('examination/marksheet_view')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#C46210;">
                         ...
                         <a href="javascript:get_content('examination/marksheet_view')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             ...
             <a href="javascript:get_content('examination/add_weekly_test')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#002B68;">
                         ...
                         <a href="javascript:get_content('examination/add_weekly_test')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             ...
             <a href="javascript:get_content('examination/view_weekly_test')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#C462FD;">
                         ...
                         <a href="javascript:get_content('examination/view_weekly_test')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             ...
             <a href="javascript:get_content('examination/resultsheet_view')">
                 <div class="col-md-3 col-md-6">
                     <div class="small-box" style="background-color:#C46210;">
                         ...
                         <a href="javascript:get_content('examination/resultsheet_view')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
