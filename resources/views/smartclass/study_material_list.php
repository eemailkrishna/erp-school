...
$("#student_class_stream").attr('required',false);
 ...
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="javascript:get_content('index_content')"><i class="fa fa-home"></i> Home</a></li>  <li><a href="javascript:get_content('smartclass/smartclass')"><i class="fa fa-book"></i> Smart Class</a></li> <li><a href="javascript:get_content('smartclass/study_material')"><i class="fa fa-book"></i> Study Material</a></li>
