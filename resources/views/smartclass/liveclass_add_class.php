...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('smartclass/liveclass')"><i class="fa fa-book"></i> Live Class</a></li>
 ...
 <div class="col-md-12">
		...
		<div class="col-md-3" id="student_class_group_div" style="display:none;">				
			    ...
			    <input type="time" value="" name="liveclass_time"   placeholder="Time"  value="" class="form-control">
				 </div>
			    </div>
			    <div class="col-md-3">	
				<div class="form-group" >
				<label>Duration(in MIN)</label>
			    <input type="number" value="" name="liveclass_duration"   placeholder="Duration" max="60" value="" class="form-control">
				 </div>
			    </div>
			<div class="col-md-3">	
				<div class="form-group" >
			  ...
			  <div class="col-md-3"  >	
			    ...
			    <select type="text" value="" name="platform_name"  id="platform_name"    class="form-control" onclick="select_platform(this.value)" required>
			  ...
			  <div class="col-md-3" id="google_meet_div"  style="display:none">		
				...
				<input type="text" name="google_platform_code" id="google_platform_code" placeholder="eg. fug-ffhk-fyy"  value="" class="form-control" pattern="[a-z]{3}-[a-z]{4}-[a-z]{3}" title="xxx-xxxx-xxx" >
				</div>
			  </div>
           <div class="col-md-3" id="zoom_meeting_div" style="display:none">		
				<div class="form-group">
				<label>Zoom Meeting ID</label>
				<input type="text" name="platform_code" id="zoom_platform_code"  placeholder="eg. 73479929571"  value="" class="form-control" pattern="[0-9]{11}" title="Please Enter 11 digit Zoom Meeting ID"required >
				</div>
			  </div>
			  <div class="col-md-3" id="zoom_meeting_password_div" style="display:none" >		
				<div class="form-group">
				<label>Zoom Meeting Password</label>
				<input type="text" name="platform_password" id="platform_password" placeholder="eg. 9U221b"  value="" class="form-control" pattern="[0-9a-zA-Z]{6}" title="Please Enter 6 Digit Zoom Meeting Password" required>
				</div>
			  </div>			 <br>
	       <div class="col-md-12">
