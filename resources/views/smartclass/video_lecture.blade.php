...
<div class="box-body">
					...
					<div class="col-lg-3 col-xs-6">
						<div class="small-box" style="background-color:#1D8348;">
							...
							<a href="javascript:get_content('smartclass/video_lecture_add')" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>

					<a href="javascript:get_content('smartclass/video_lecture_list')">
					<div class="col-lg-3 col-xs-6">
						<div class="small-box" style="background-color:#8E44AD;">
							...
							<a href="javascript:get_content('smartclass/video_lecture_list')" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
