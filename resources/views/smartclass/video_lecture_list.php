...
<script type="text/javascript">
	    ...
	    var student_class=document.getElementById('student_class').value;
			$.ajax({
			address: "POST",
			url: access_link+"important_ajax/get_subject_all.php?class_name="+student_class+"&class_stream="+student_class_stream+"&class_group=All",
			cache: false,
...
<div class="box-body">
              ...
              <div class="form-group">
				<label>Class</label>
				<select name="student_class" id="student_class" class="form-control" onchange="for_subject();for_search();for_stream(this.value);" >
			  ...
			  <div class="col-md-3 " id="student_class_stream_div" style="display:none;">				
					<div class="form-group">
					  <label >Stream<font style="color:red"><b>*</b></font></label>
					    <select class="form-control" name="student_class_stream" id="student_class_stream" onchange="for_search();for_subject();" >
					     	 <option  value="">Select</option>
...
<div class="col-md-12">
<div class="col-md-6">
<center><button type="button" class="btn btn-success" onclick="exportTableToExcel('example1', 'Video Lecture Report')"><i class="fa fa-print" aria-hidden="true"></i>Print In Excel</button></center>
</div>
<div class="col-md-6">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         	<div class="col-md-12">	
			   ...
			   <div class="col-md-12">		
				<div class="form-group">
				<label>Remark</label>
				<input type="text" name="video_remark" placeholder="Remark"  value="" id="video_remark" class="form-control" >
				</div>
			  </div>
		...
		<input type="button"  data-dismiss="modal" onclick="form_submit();" value="Add" class="btn btn-success" />
          <button type="button" id="modal_close1" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
      </div>
...
<script>
   function for_search(){
	    ...
	    var student_class_stream=document.getElementById('student_class_stream').value;
	        ...
	        var pass_var="?student_class="+student_class+"&particular_date="+particular_date+"&subject_name="+subject_name+"&student_class_stream="+student_class_stream;
