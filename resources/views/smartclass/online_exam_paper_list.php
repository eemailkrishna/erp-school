 ...
 <div class="box-body ">
     <div class="col-md-2">
              <div class="form-group">
				<label>Class</label>
				<select name="student_class" id="student_class" class="form-control" onchange="for_subject();for_stream(this.value);" >
              ...
              <div class="form-group">
				...
				<div class="col-md-2">	
					<div class="form-group" >
					    <label>&nbsp;</label>
						<button class="btn btn-success form-control" type="button" onclick="for_list()">Get List</button>
					    </select>
					</div>
				</div>
	<div class="col-md-12">
 ...
 for_list('');
   ...
   function for_list(){
    ...
    var dataTable=$('#example1').DataTable({
                ...
                "serverSide":true,
                "ajax":{
                    url:access_link+"smartclass/online_exam_paper_list_fetch.php?student_class="+student_class+"&publish="+publish+"&subject_name="+subject_name+"&stream_name="+stream_name+"&submission_date="+submission_date+"",
                    type:"post"
                }
            });
    }
