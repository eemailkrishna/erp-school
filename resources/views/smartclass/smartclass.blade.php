            ...
            <a href="{{url('smartclass/video_lecture')}}">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#808000;">
                        ...
                        <a href="javascript:get_content('smartclass/video_lecture')" class="small-box-footer">More info
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#800080;">
                        ...
                        <a href="javascript:get_content('smartclass/homework')" class="small-box-footer">More info <i
            ...
            <a href="javascript:get_content('smartclass/notification')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#008080;">
                        ...
                        <a href="javascript:get_content('smartclass/notification')" class="small-box-footer">More info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#800000;">
                        ...
                        <a href="javascript:get_content('smartclass/study_material')" class="small-box-footer">More info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="javascript:get_content('smartclass/online_exam')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#008000;">
                        ...
                        <a href="javascript:get_content('smartclass/online_exam')" class="small-box-footer">More info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('smartclass/result_show')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#008080;">
                        ...
                        <a href="javascript:get_content('smartclass/result_show')" class="small-box-footer">More info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('smartclass/active_user_list')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#008000;">
                        ...
                        <a href="javascript:get_content('smartclass/active_user_list')" class="small-box-footer">More
            ...
            <a href="javascript:get_content('smartclass/liveclass')">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#F4a943;">
                        ...
                        <a href="javascript:get_content('smartclass/liveclass')" class="small-box-footer">More info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
