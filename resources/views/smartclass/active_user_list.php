...
<section class="content">
     <div class="box box-success ">
            ...
            <div class="box-body table-responsive">
                <div class="col-md-12">
<div class="col-md-6">
<center><button type="button" class="btn btn-primary" onclick="exportTableToExcel('printTable', 'Active Student List')"><i class="fa fa-print" aria-hidden="true"></i>Print In Excel</button></center>
</div>
<div class="col-md-6">
