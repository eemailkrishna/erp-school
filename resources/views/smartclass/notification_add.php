...
window.scrollTo(0, 0);
 ...
 <li><a href="javascript:get_content('smartclass/smartclass')"><i class="fa fa-dashboard"></i> Smart Class</a></li>
        <li><a href="javascript:get_content('smartclass/notification')"><i class="fa fa-book"></i>Notification Panel</a></li>
            ...
            <div class="box-body "  >
			 ...
			 <div class="col-md-3">	
					<div class="form-group" >
					    ...
					    <select name="notification_class" onchange="for_section(this.value);" id="class_name" class="form-control" required>
	         ...
	         <div class="col-md-3">	
			    ...
			    <input type="date" value="2022-12-03" name="notification_date" id="myLocalDate"  placeholder="Date"  value="" class="form-control" required>
				 </div>
			  </div>
			  <div class="col-md-3">		
				<div class="form-group">
				<label>Remark</label>
				<input type="text" name="notification_remark" placeholder="Remark"  value="" class="form-control" >
				</div>
			  </div>
			  
			  <div class="col-md-12">
                <textarea id="" name="notification" class="form-control " placeholder="Write Notification" rows="4"  required></textarea>
