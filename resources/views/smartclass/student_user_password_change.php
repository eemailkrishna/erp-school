...
$.ajax({
type: "POST",
url: access_link+"smartclass/student_user_password_change_ajax.php?class_name="+class_name+"&class_section="+class_section+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"",
cache: false,
success: function(detail){
         ...
         <div class="box box-success " style="padding:10px 10px 10px 10px;">
            ...
            <div class="col-md-12">
			  <div class="form-group">
				<label>Class :</label>
				<select name="student_class" id="student_class" class="form-control" onchange="for_section(this.value);for_stream(this.value)" required>
