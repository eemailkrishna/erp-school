    ...
    function for_section(value){
       ...
       $.ajax({
		...
		function for_subject(){
			...
			$.ajax({
			address: "POST",
			url: access_link+"important_ajax/get_subject.php?class_name="+student_class+"&class_stream="+student_class_stream+"&class_group="+student_class_group+"",
			cache: false,
			success: function(detail){
          	...
          	<div class="col-md-12">	
				<div class="col-md-3 ">	
					<div class="form-group" >
					    <label>Class</label>
					    <select name="exam_stuff_class" onchange="for_section(this.value);for_subject();for_stream(this.value);for_search();" id="student_class" class="form-control" required>
			    	...
			    	<div class="col-md-3 ">				
					 <div class="form-group" >
					  <label>Document Type</label>
						 <select name="document_type" onchange="for_document_type(this.value);"  class="form-control" required>
				...
				<div class="col-md-3" style="display:none" id="link_div">				
			     ...
			     <div class="col-md-4" id="file_upload_div">	
					<div class="form-group" >
					  ...
					  <input type="file" id="upload_file" name="upload_file" value="" class="form-control" accept=".gif, .jpg, .jpeg, .png, .pdf"  >
					</div>
				</div>
