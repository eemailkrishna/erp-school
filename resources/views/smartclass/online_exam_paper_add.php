...
<script>
   ...
   $('#subject_name').html("<option value='' >Loading....</option>");
			$.ajax({
			address: "POST",
			url: access_link+"important_ajax/get_subject.php?class_name="+student_class+"&class_stream="+student_class_stream+"&class_group=",
			cache: false,
    ...
    <section class="content">
         <div class="box box-success ">
		   ...
		   <div class="box-body">
		   	<div class="col-md-12">
				...
				<div class="col-md-6">
					...
					<input type="hidden" name="current_date" value="03122022053605" class="form-control" id="current_date" />
				</div>
				</div>
					<div class="col-md-12">
				<div class="col-md-3">
					...
					<input type="text" name="paper_name" style="" class="form-control" id="paper_name" oninput="create_unique_id();" required />
				 ...
				 <div class="col-md-3">				
					 <div class="form-group" >
					  <label>Class</label>
					    <select name="class_name" style="" id="class_name" class="form-control" onchange="for_subject();" required >
		  ...
		  <div class="col-md-2 " id="student_class_stream_div" style="display:none;">				
					<div class="form-group">
					  <label >Stream</label>
					    <select class="form-control"  id="student_class_stream" onchange="for_subject();create_unique_id();" >
				...
				<div class="col-md-3">				
					 <div class="form-group" >
					  <label >Subject</label>
					  <select name="subject_name" style="" class="form-control" id="subject_name" onchange="create_unique_id();" required>
				...
				<div class="col-md-3">				
					 <div class="form-group" >
					  ...
					  <select name="paper_language" style="" id="paper_language" class="form-control" onchange="create_unique_id();" required>
			 ...
			 <br/>
			 <div class="col-md-12">			 
					 <center><button type="submit" name="submit" id="my_submit" class="btn btn-success" >Submit</button></center><br/>
			 </div>
